...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Vector2 FlightStick
        {
            get
            {
                return SteamVR_Actions.default_FlightStick;
            }
        }
        
        public virtual SteamVR_Action_Single YawControl
        {
            get
            {
                return SteamVR_Actions.default_YawControl;
            }
        }
        
        public virtual SteamVR_Action_Single ThrustControl
        {
            get
            {
                return SteamVR_Actions.default_ThrustControl;
            }
        }
