...
namespace Valve.VR
{
    public partial class SteamVR_Input
    {
        ...
        public static void Initialize(bool force = false)
        {
            ...
            if (/*SteamVR_Settings.instance.activateFirstActionSetOnStart*/ true)
            {
            ...
            SteamVR_Action_Pose.SetTrackingUniverseOrigin(/*SteamVR_Settings.instance.trackingSpace*/ KerbalVR.Scene.Instance.TrackingSpace);
        ...
        public static bool HasFileInMemoryBeenModified()
        {
            ...
            string newJSON = JsonUtility.ToJson(SteamVR_Input.actionFile, true);
        ...
        public static bool CreateEmptyActionsFile(bool completelyEmpty = false)
        {
            ...
            string newJSON = JsonUtility.ToJson(actionFile, true);
        ...
        public static string GetActionsFilePath(bool fullPath = true)
        {
            ...
            string path = Path.Combine(streamingAssets_SteamVR, "actions.json");
