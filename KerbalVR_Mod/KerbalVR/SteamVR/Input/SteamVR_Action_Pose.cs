    ...
    public class SteamVR_Action_Pose_Source : SteamVR_Action_In_Source, ISteamVR_Action_Pose
    {
        ...
        public virtual void UpdateValue(bool skipStateAndEventUpdates)
        {
            ...
            if (framesAhead == 0)
                ...
                float displayFrequency = Utils.GetFloatTrackedDeviceProperty(ETrackedDeviceProperty.Prop_DisplayFrequency_Float);
                err = OpenVR.Input.GetPoseActionDataRelativeToNow(handle, universeOrigin, framesAhead * (Time.timeScale / displayFrequency), ref poseActionData, poseActionData_size, inputSourceHandle);
            }
